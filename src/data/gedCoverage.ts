...
export const gedTopics: GedTopic[] = [
  ...
  { title: 'Functions / substitutions', path: 'calculator', state: 'ready', lessonIds: ['function-lines', 'calculator-entries'] },
  { title: 'Equations of lines', path: 'calculator', state: 'ready', lessonIds: ['slope-points', 'function-lines'] },
  ...
  { title: 'Calculator word problems', path: 'calculator', state: 'ready', lessonIds: ['calculator-entries', 'mixed-check'] },

  { title: 'Area', path: 'formula-sheet', state: 'ready', lessonIds: ['area-formulas', 'formula-sheet-route'] },
  { title: 'Perimeter / circumference', path: 'formula-sheet', state: 'ready', lessonIds: ['circles-right-triangles', 'formula-sheet-route'] },
  ...
  { title: 'Decimals / order numbers', path: 'no-calculator', state: 'ready', lessonIds: ['order-rational', 'no-calculator-route'] },
  { title: 'Order of operations', path: 'no-calculator', state: 'ready', lessonIds: ['order-of-operations', 'no-calculator-route'] },
  ...
  { title: 'Algebraic statements', path: 'mixed', state: 'ready', lessonIds: ['translate-expressions', 'two-step-equations'] },
