...
export const modules: CourseModule[] = [
  ...
  { id: 'number-sense', title: 'Number Sense', subtitle: 'Number lines, raised numbers and roots', purpose: 'Cover the no-calculator symbols and target-word traps that already appeared in practice.', lessonIds: ['number-line-distance', 'powers-roots', 'order-rational', 'scientific-notation', 'rational-exponents', 'undefined-expressions'], phase: 'Core' },
  { id: 'percent', title: 'Percents & Money', subtitle: 'Discounts, tax, increases, original amount', purpose: 'Handle one money or percent move at a time.', lessonIds: ['percent-change', 'sales-tax', 'reverse-increase', 'simple-interest'], phase: 'Core' },
  { id: 'equations', title: 'Equations', subtitle: 'Undo steps without fighting the letter x', purpose: 'Translate GED algebra into n notation and solve in written moves.', lessonIds: ['two-step-equations', 'variables-both-sides', 'check-answer-choices'], phase: 'Core' },
  { id: 'ratios', title: 'Ratios & Proportions', subtitle: 'Recipes, packs, map scales', purpose: 'Find a one-unit amount, then scale it up.', lessonIds: ['unit-ratios', 'unit-conversions'], phase: 'Core' },
  ...
  { id: 'geometry', title: 'Geometry Formulas', subtitle: 'Area, circles, right triangles, volume', purpose: 'Read the formula sheet, plug in numbers, then calculate.', lessonIds: ['area-formulas', 'circles-right-triangles', 'cylinder-volume', 'surface-area'], phase: 'Core' },
  ...
  { id: 'data', title: 'Data & Averages', subtitle: 'Graphs, median, mean, range', purpose: 'Read data displays and calculate the center of a data set.', lessonIds: ['data-averages', 'weighted-average'], phase: 'Core' },
