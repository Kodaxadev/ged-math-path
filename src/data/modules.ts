...
export const modules: CourseModule[] = [
  ...
  { id: 'number-sense', title: 'Number Sense', subtitle: 'Number lines, raised numbers and roots', purpose: 'Cover the no-calculator symbols and target-word traps that already appeared in practice.', lessonIds: ['number-line-distance', 'powers-roots', 'order-rational', 'scientific-notation'], phase: 'Core' },
