...
export const geometryLessons: Lesson[] = [
  {
    ...
    practice: [{ id: 'triangle-area', prompt: 'A triangle has a base of 14 inches and a height of 9 inches. What is its area?', answer: '63 square inches', procedure: 'A = 1/2 × base × height.', steps: ['Write the formula: A = 1/2 × b × h.', 'Insert values: A = 1/2 × 14 × 9.', 'Half of 14 is 7; 7 × 9 = 63.', 'Answer: 63 square inches.'] }],
  },
  {
    ...
    practice: [{ id: 'cylinder-2', prompt: 'A cylinder has radius 2 and height 5. What is its volume in terms of π?', answer: '20π cubic units', procedure: 'V = π × r² × h.', steps: ['V = π × 2² × 5.', '2² = 4.', 'π × 4 × 5 = 20π.'] }],
  },
];
